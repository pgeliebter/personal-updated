<template>
  <body ref="scrollSections" class="bg-light">
    ...
    <div data-scroll-container>
      <!--Header Start-->
      <header class="header-fixed-top header-transparent z-index-fixed">
        <nav class="navbar navbar-expand-lg navbar-dark py-3">
          <div class="container position-relative">
            <a class="navbar-brand width-30" href="index.html">
              <img src="assets/img/logo/logo-a.svg" alt class="img-fluid" />
            </a>
      ...
      <!--Offcanvas dark-->
      <div
        class="offcanvas offcanvas-end bg-shade-primary text-white"
        tabindex="-1"
        id="offcanvasEnd"
      ...
      >
        ...
        <div class="offcanvas-body p-4 px-xl-5">
          <ul class="nav flex-column">
            <li class="nav-item">
              <a href="#" class="nav-link fs-2 fw-normal">Index</a>
            </li>
            <li class="nav-item">
              <a href="#" class="nav-link fs-2 fw-normal">About</a>
            </li>
            <li class="nav-item">
              <a href="#" class="nav-link fs-2 fw-normal">Portfolio</a>
            </li>
            <li class="nav-item">
              <a href="#" class="nav-link fs-2 fw-normal">Capabilities</a>
            </li>
            <li class="nav-item">
              <a href="#" class="nav-link fs-2 fw-normal">Get in touch</a>
            </li>
          </ul>
        </div>
        <div class="offcanvas-footer p-4 px-xl-5">
          <ul class="list-unstyled mb-0">
            <li class="pb-4">
              ...
              <a href="mailto:mail@domain.com" class="link-underline fs-5"
                >mail@domain.com</a
              >
            </li>
            <li>
                    ...
                    <li class="js-hover-img-item">
                      <h1 class="js-hover-img-link display-1 mb-0">
                        <small class="fs-4 ls-1 fw-normal"
                          >👋Hi, I Am Aaron Nunez</small
                        >
                        <br />Freelance Web Designer and Visual Developer.
                      </h1>
                      <img
            ...
            <div class="row align-items-stretch">
              <div class="col-md-10 col-xl-5 ms-auto order-last">
                <h3
                  ...
                  data-scroll-speed="1"
                >
                  My creative journey started at Jaipur where I studied for the
                  past years. I’ve been able to work with talented people,
